...
export const creditCardUsageSchema = z.object({
    ...
    paymentHistory: z.array(
        z.object({
            month: z.enum(["jan", "fab", "march", "april", "may", "june", "july", "aug", "sept", "oct", "nav", "dec"], { required_error: "month is requied", invalid_type_error: "month is incorrect" }),
            ontime: z.boolean({
...
export const upiHistorySchema = z.object({
    ...
    lastSixMonthsTransactions: z.array(
        z.object({
            month: z.enum(["jan", "fab", "march", "april", "may", "june", "july", "aug", "september", "octuuber"]),
            volume: z.number({
